...
#SBATCH --output=gpt2_test_%j.out      # Set this dir where you want slurm outs to go
#SBATCH --error=gpt2_test_%j.out      # Set this dir where you want slurm outs to go
...
srun python -m levanter.main.train_lm \
    --config ${LEVANTER_HOME}/config/gpt2_small_fast.yaml 
